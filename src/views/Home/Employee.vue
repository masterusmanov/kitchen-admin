<template>
    <div class="container mx-auto">
        <h3 class="text-[18px] font-[400]">Ishchilar</h3> 
      <div class="mt-[24px] flex justify-between items-center">
        <h1 class="text-[40px] font-[600] font-self">Ishchilar</h1>
            ...
            <div class="relative w-[800px] p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    <h3 class="text-[24px] font-semibold text-gray-900 dark:text-white">
                        <span v-if="!isUpdate">Ishchilar haqida malumotlar</span>
                        <span v-else>Ishchilar malumotlarini yangilash</span>
                    </h3>
                ...
                <form >
                    <div class="grid gap-4 mb-4 sm:grid-cols-1">
                        ...
                        <div class="flex justify-between gap-6">
                            <div class="w-full">
                                <div class="mt-3">
                                    <label for="name" class="block mb-2 text-[16px] font-medium text-gray-900 dark:text-white">Ismi</label>
                                ...
                                <div class="mt-3">
                                  <label for="surname" class="block mb-2 text-[16px] font-medium text-gray-900 dark:text-white">Familiyasi</label>
                                  <input v-model="contactInfo.surname" type="text" name="surname" id="surname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Familiyasi" required="">
                                </div>
                                <div class="mt-3">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead class="text-md text-white font-bold uppercase bg-gray-500 ">
                            <tr class="">
                                <th scope="col" class="px-4 py-3 text-left">Ismi va Familiyasi</th>
                                <th scope="col" class="px-4 py-3 text-left">Telefon raqami</th>
                                <th scope="col" class="px-4 py-3 text-left">Ish roli</th>
  ...
  const updateContact = (id)=>{
      ...
      contactInfo.surname = foundContact[0].surname
      ...
      contactInfo.role = foundContact[0].role
      toggleModal();
  }
