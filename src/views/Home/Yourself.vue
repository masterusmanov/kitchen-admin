<template>
    <div class="container mx-auto">
        <h3 class="text-[18px] font-[400]">O'zingiz tanlang</h3> 
      <div class="mt-[24px] flex justify-between items-center">
        <h1 class="text-[40px] font-[600] font-self">O'zingiz tanlang</h1>
    ...
    <!-- -------------------------end of modal------------------------------------- -->
      ...
      <div class="flex flex-wrap justify-beetwen items-center mt-10 gap-5 2xl:gap-8">
        <div class="lg:w-[23%] lg:h-[250px] 2xl:w-[23%] 2xl:h-[307px] grid justify-center items-center border bg-[#F4F4F4] py-[24px] rounded-[7px] shadow-md">
          ...
          <img src="../../assets/images/menu/3.png" alt="" class="w-[120px] h-[120px] mx-auto">
  ...
  <script setup>
    ...
    import { yourselfStore } from '../../stores/yourselfStore';
    import {useRouter} from 'vue-router'
    import { yourselfs } from '../../service/yourself';
    ...
    const addContact=(evet)=>{
        ...
        yourselfs.create(contact).then((res)=>{
            if(res.status == 201){
                contactInfo.note_uzb=''
                contactInfo.dish_uzb=''
                contactInfo.dish_rus=''
    ...
    const modifyContact=(event)=>{
        ...
        yourselfs.update(id, contact).then((res)=>{
            if(res.status == 200){
