<template>
    <div class="container mx-auto">
        <h3 class="text-[18px] font-[400]">Salatlar</h3> 
      <div class="mt-[24px] flex justify-between items-center">
        <h1 class="text-[40px] font-[600] font-self">Salatlar</h1>
  ...
  <script setup>
    ...
    import { salads } from '../../service/salads';
    ...
    const addContact=(evet)=>{
        ...
        salads.create(contact).then((res)=>{
            if(res.status == 201){
                contactInfo.note_uzb=''
                contactInfo.dish_uzb=''
                contactInfo.dish_rus=''
    ...
    const modifyContact=(event)=>{
        ...
        salads.update(id, contact).then((res)=>{
            if(res.status == 200){
